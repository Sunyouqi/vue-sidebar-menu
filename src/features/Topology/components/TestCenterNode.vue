...
const rightPorts = computed(() => (props.data.interfaces ?? []).filter((interfaces) => interfaces.side !== 'left'))
...
.device-node {
  ...
  padding: 14px 18px;
  border: 1px solid #825eb5;
  border-radius: 16px;
  background: linear-gradient(145deg, #3b285f, #251940);
  color: #f2eaff;
